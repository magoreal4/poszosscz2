...
const scrollContainer = navigator && /(EDGE|Mac)/i.test(navigator.userAgent)
  ? document.body
...
shadowProps$1.forEach((x) => { shadowPropOnStart$1[x] = onStartShadow; });
